...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Jacob\Desktop\Data Structures with Flask\venv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Jacob\Desktop\Data Structures with Flask\venv\Scripts\deactivate.nu'
